    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-black">
      ...
      <div className="container mx-auto px-6 z-10 text-center">
        ...
        <h1 className="text-6xl md:text-8xl font-bold text-white mb-6 animate-slide-up">
          Hi, I'm <span className="bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-500 text-transparent bg-clip-text animate-gradient">Your Name</span>
        </h1>
        ...
        <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-12 animate-fade-in-up leading-relaxed">
          Building scalable web applications with Django, FastAPI, Next.js, and cloud technologies.
          Passionate about DevOps and modern database solutions.
        </p>
        
        <div className="flex gap-6 justify-center animate-fade-in-up-delayed">
          <a href="#projects" className="group px-10 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-lg font-semibold hover:shadow-2xl hover:shadow-blue-500/50 transition-all transform hover:scale-105 relative overflow-hidden">
            <span className="relative z-10">View Projects</span>
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-600 to-blue-600 opacity-0 group-hover:opacity-100 transition-opacity"></div>
          </a>
          <a href="#contact" className="px-10 py-4 bg-gray-900 text-white rounded-lg font-semibold hover:bg-gray-800 transition-all transform hover:scale-105 border border-gray-800 hover:border-cyan-500">
            Contact Me
          </a>
        </div>
      </div>
